...
from class_model import RNN, LSTM

def accuracyCheck(y_hat, y):
...
def evaluate(data_set, model, params, criterion, validation=False):
    ...
    test_acc = tot_correct/len(data_set)
...
def main():
    ...
    for e in range(params["EPOCHS"]):
        ...
        val_loss, val_acc = evaluate(val_data, model, params, criterion, validation=True) 
    ...
    test_loss, test_acc = evaluate(test_data, model, params, criterion)
